...
namespace UNO_Client
{
    public partial class Form1 : Form
    {
        ...
        private async void btn_dangnhap_Click_1(object sender, EventArgs e)
        {
        ...
        private async void btn_dk_Click_1(object sender, EventArgs e)
        {
            string email = tb_taikhoan.Text;
            string password = tb_matkhau.Text; // đưa tk mk từ text box vào thành chuỗi
            if (string.IsNullOrEmpty(email) || string.IsNullOrEmpty(password))
        ...
        private async void btn_quenmk_Click_1(object sender, EventArgs e)
        {
            string email = tb_taikhoan.Text;
